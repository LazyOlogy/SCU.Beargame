<%@ Page Language="C#" AutoEventWireup="true" CodeFile="record_report.aspx.cs" Inherits="admin_record_report" %>
    ...
    <div id="ALL">
        ...
        <div id="MIDDLE">
        	<div class="content" style="width:100%;">
             ...
             <div class="crumb"  align="center"><asp:Label ID="LB_Tip" runat="server" Text="產生圖表中，請稍候。" BorderColor="White"></asp:Label></div>               
               <div class="blank"></div>
...
<script type="text/javascript">
    function PanelSet() {
        ...
        switch (GetUrlVar('target')) {
            ...
            document.getElementById('P_Stock').className = "active";
        document.getElementById('P_Stock').href = "record_report.aspx?G_ID=" + GetUrlVar('G_ID') + "&target=Stock_Amount";
        document.getElementById('P_Order').href = "record_report.aspx?G_ID=" + GetUrlVar('G_ID') + "&target=Order_Amount";
        document.getElementById('P_WeekCost').href = "record_report.aspx?G_ID=" + GetUrlVar('G_ID') + "&target=Cost_Amount";
        document.getElementById('P_TotalCost').href = "record_report.aspx?G_ID=" + GetUrlVar('G_ID') + "&target=Total_Cost";
        document.getElementById('P_Composite').href = "record_report.aspx?G_ID=" + GetUrlVar('G_ID') + "&target=Composite";
        document.getElementById('P_AreaComposite').href = "record_report.aspx?G_ID=" + GetUrlVar('G_ID') + "&target=AreaComposite";
    }
